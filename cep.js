document.addEventListener('DOMContentLoaded', () => {
    ...
    function addMessageToChat(sender, text, addToHistory = true) {
        if (addToHistory) {
    ...
    chatForm.addEventListener('submit', async (e) => {
        ...
        const loadingMessage = addMessageToChat('ai', 'loading', false);
        
        setTimeout(() => {
            const aiResponseText = "That's a great question! Based on your interest in '" + userInput + "', you might want to explore careers like Software Engineer or Data Scientist. Both require strong analytical skills. Would you like to know more about either of those?";
